...
<head>
    ...
    <link rel="stylesheet" id="custom-css" href="{{ asset(config('settings.theme')) }}/css/jquery-ui.css" type="text/css" media="all" />
    ...
    <script type="text/javascript" src="{{ asset('pink/js/jquery-1.11.0.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('pink/js/ckeditor/ckeditor.js') }}"></script>
    <script type="text/javascript" src="{{ asset('pink/js/bootstrap.min.js') }}"></script>
        ...
        <div id="header" class="group">
            ...
            <div class="group inner">
                ...
                <div id="logo" class="group">
                    <a href="{{ route('adminIndex') }}" title="Pink Rio"><img src="{{ asset(config('settings.theme')) }}/images/logo.png" title="Pink Rio" alt="Pink Rio" /></a>
                </div>
                <!-- END LOGO -->
